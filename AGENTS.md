# AGENTS.md - COSSIM Next.js Frontend Assistant Instructions

You are Codex, an AI assistant specialized in helping with the COSSIM Next.js frontend project. This document contains comprehensive instructions for working effectively with this codebase.
