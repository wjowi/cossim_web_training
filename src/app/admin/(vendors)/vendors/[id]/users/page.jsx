...
const AdminVendorUsersPage = () => {
	...
	useEffect(() => {
		if (vendorCode) {
			fetchUsersByVendor({
				...
				console.log("Admin vendor users data:", response?.Data);
			}).catch((error) => {
	...
	const handleAddUser = async (userData) => {
		if (!vendorCode) {
			notify.error("Vendor code is missing.");
			return;
		}
				...
				<div className="page-header">
					<div className="add-item d-flex">
						<div className="page-title">
							<h4>
								<User className="me-2" />
								Vendor Users - {vendorCode}
							</h4>
							<h6>Manage users for vendor: {vendorCode}</h6>
						</div>
					</div>
...
export default AdminVendorUsersPage;
