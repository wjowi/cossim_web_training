...
const SalesManagersList = () => {
  ...
  // Fetch sales managers on component mount
  useEffect(() => {
    fetchUsersByRole({
      RoleTypeCode: RoleType.SALES_MANAGER,
      PageNO: currentPage,
      PageSize: pageSize,
  ...
  const showConfirmationAlert = () => {
    MySwal.fire({
      title: "Are you sure?",
      text: "This will remove the sales manager assignment!",
      ...
      if (result.isConfirmed) {
        notify.success("Sales manager assignment removed.");
      }
    });
  };
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (EmailAddress) => EmailAddress || "N/A",
    ...
    },
    {
      ...
      render: (_, record) => (
        <RowActionsDropdown
          ...
          items={[
            { key: 'view', label: 'View', icon: 'feather-eye', href: `/admin/sales-managers/${record.UserCode}` },
            { key: 'edit', label: 'Edit', icon: 'feather-edit', href: `/admin/sales-managers/edit/${record.UserCode}` },
        ...
        <div className="page-header">
          <div className="add-item d-flex">
            <div className="page-title">
              ...
              <h6>Manage sales manager assignments</h6>
            </div>
          </div>
