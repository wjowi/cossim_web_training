...
const EditCustomerAddressModal = ({ show, onClose, onSubmit, address, currentUserId }) => {
  ...
  useEffect(() => {
    if (show && address) {
      setFormData({
        ...
        customerAddressDCCode: address.CustomerAddressDCCode || '',
        ...
        <Form onSubmit={handleSubmit}>
          <Row>
            <Col md={6}>
              <Form.Group className="mb-3">
                <Form.Label>Address Code</Form.Label>
                <Form.Control
                  type="text"
                  name="vendorCustomerAddressCode"
                  value={formData.vendorCustomerAddressCode}
                  readOnly
                  disabled
                />
              </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <SSRSelect
              ...
              instanceId="edit-customerAddressDCCode-select"
            />
          </Form.Group>
