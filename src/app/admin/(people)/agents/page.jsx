...
const AgentsList = () => {
  ...
  // Fetch sales agents on component mount
  useEffect(() => {
    fetchUsersByRole({
      RoleTypeCode: RoleType.SALES_AGENT,
      PageNO: currentPage,
      PageSize: pageSize,
  ...
  const showConfirmationAlert = () => {
    MySwal.fire({
      title: "Are you sure?",
      text: "This will remove the agent!",
    ...
    },
    {
      ...
      render: (_, record) => (
        <RowActionsDropdown
          ...
          items={[
            { key: 'view', label: 'View', icon: 'feather-eye', href: `/admin/agents/${record.UserCode}` },
            { key: 'edit', label: 'Edit', icon: 'feather-edit', href: `/admin/agents/edit/${record.UserCode}` },
        ...
        <div className="page-header">
          <div className="add-item d-flex">
            <div className="page-title">
              <h4>Sales Agents</h4>
              <h6>Manage your sales agents</h6>
            </div>
          </div>
          ...
          <div className="page-btn">
            <Link to="/admin/agents/add" className="btn btn-added">
