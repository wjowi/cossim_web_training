    ...
    },
    {
      ...
      render: (_, record) => (
        <RowActionsDropdown
          ...
          items={[
            { key: 'view', label: 'View', icon: 'feather-eye', href: `/admin/vendors/${record.vendorCode}` },
            { key: 'edit', label: 'Edit', icon: 'feather-edit', onClick: () => handleEditVendor(record) },
            { key: 'users', label: 'Users', icon: 'feather-user', href: `/admin/vendors/${record.vendorCode}/users` },
            { key: 'products', label: 'Products', icon: 'feather-package', href: `/admin/vendors/${record.vendorCode}/products` },
            { key: 'stores', label: 'Stores', icon: 'feather-home', href: `/admin/vendors/${record.vendorCode}/stores` },
