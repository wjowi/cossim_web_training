...
export default function GeneralProfile() {
  ...
  // General user performance stats
  const performanceStats = [
    ...
    {
      title: "Account Age",
      value: "0 days", // This would come from API
    ...
    },
    {
      ...
      color: formData.status === "Active" ? "success" : "danger",
      icon: Shield
    }
  ];

  // Mock recent activities for general user
  ...
  return (
    <div className="content">
      ...
      <div className="d-flex align-items-center justify-content-between mb-4">
        <div>
          <h4 className="page-title mb-1">My Profile</h4>
        ...
        <Col lg={4}>
          <Card className="border-0 shadow-sm rounded-3 h-100">
            <Card.Body className="p-4 text-center">
              ...
              <p className="text-muted mb-2">General User</p>
              ...
              {userData.AssignedRoles && userData.AssignedRoles.length > 0 && (
                <div className="mt-3 p-3 bg-light rounded-3">
                  <h6 className="fw-semibold mb-2">Assigned Roles</h6>
          ...
          <Card className="border-0 shadow-sm rounded-3 mt-4">
            <Card.Header className="border-0 bg-transparent pt-4 px-4 pb-0">
              <h6 className="fw-semibold mb-0">Account Overview</h6>
            </Card.Header>
              ...
              <Tabs activeKey={activeTab} onSelect={(k) => setActiveTab(k)} className="mb-4">
                <Tab eventKey="profile" title="Profile Information">
                  <Form>
                    <Row className="g-4">
                      ...
                      <Col md={6}>
                        <Form.Group>
                          <Form.Label className="fw-semibold">User Code</Form.Label>
                          <Form.Control
                            type="text"
                      ...
                      <Col md={6}>
                        <Card className="border-2 border-light">
                          <Card.Body className="p-3 d-flex align-items-center">
                            ...
                            <div className="flex-grow-1">
                              <h6 className="mb-1">Privacy Settings</h6>
                              <small className="text-muted">Manage data sharing preferences</small>
                            </div>
                      ...
                      <Col md={6}>
                        <Card className="border-2 border-light">
                          <Card.Body className="p-3">
                            <div className="d-flex align-items-center justify-content-between">
                              <div className="d-flex align-items-center">
                                <Activity size={16} className="me-2 text-info" />
                ...
                <Tab eventKey="activity" title="Recent Activity">
                  <div className="activity-log">
                    <h6 className="fw-semibold mb-3">Account Activities</h6>
