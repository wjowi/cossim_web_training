    ...
    return (
      <div className="content">
        <Alert variant="danger" className="text-center">
          ...
          <Link to="/vendor/vendor-packages" className="btn btn-primary">
    ...
    <div className="content">
      <div className="page-header">
        ...
        <div className="page-btn d-flex gap-2">
          <Link to="/vendor/vendor-packages" className="btn btn-outline-secondary">
            <ArrowLeft size={16} className="me-2" />
            Back to Packages
          </Link>
          <Link to={`/vendor/vendor-track?trackingNumber=${packageData.OrderNO}`} className="btn btn-primary">
          ...
          <Card className="mb-4">
            ...
            <Card.Body>
              <div className="d-flex gap-3 flex-wrap">
                ...
                <Link to="/vendor/vendor-packages" className="btn btn-outline-primary">
                  <ArrowLeft size={16} className="me-2" />
              ...
              <div className="mt-4 p-3 bg-light rounded">
                ...
                <p className="text-muted mb-0 small">
                  You can track the real-time status of this package and view detailed timeline information.
                  Contact customer support if you notice any issues with the delivery.
                </p>
              </div>
            </Card.Body>
          </Card>
